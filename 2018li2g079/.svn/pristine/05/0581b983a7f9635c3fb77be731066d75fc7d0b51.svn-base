...
*/
#define ABRIR_SVG(tamx, tamy)				printf("<svg width=%d height=%d  style=background: red>\n", tamx, tamy);

											
/**
\brief Macro para criar um retangulo no ecrã.
@param tamx O comprimento do svg
@param tamy A altura do svg
*/
#define RETANGULO(tamx, tamy)				printf("<rect x = 0 y = 0 width=%d height=%d style=fill:#608060 /> \n", tamx, tamy);
